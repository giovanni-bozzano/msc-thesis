...
\begin{figure}[htb]
  ...
  \caption
  [Representation of the MovieLens Hetrec 2011 Dense training set.]
  {\protect\raggedright Representation of the MovieLens Hetrec 2011 Dense training set.}
  \includegraphics[width=\textwidth]{pictures/movielens-sparse-target}
  \caption
  [Representation of the MovieLens Hetrec 2011 Sparse training set.]
  {\protect\raggedright Representation of the MovieLens Hetrec 2011 Sparse training set.}
\end{figure}
...
\begin{figure}[htb]
  ...
  \caption
  [Heatmap of the MovieLens Hetrec 2011 original training set.]
  {\protect\raggedright Heatmap of the MovieLens Hetrec 2011 original training set.}
  \includegraphics[width=\textwidth]{pictures/movielens-full-target-filled}
  \caption
  [Heatmap of the MovieLens Hetrec 2011 filled training set.]
  {\protect\raggedright Heatmap of the MovieLens Hetrec 2011 filled training set.}
\end{figure}
